...
export const Side = styled.div<SideProps>`
  ...
  border-right: 2px solid ${({ theme }) => theme.border.color};
  border-left: 2px solid ${({ theme }) => theme.border.color};
  border-top: 2px solid ${({ theme, tophovered }) => tophovered ? theme.border.highlightedColor : theme.border.color};
  border-bottom:  ${({bottomradius: bottomRadius}) => bottomRadius ? bottomRadius : '2px'} solid ${({ theme }) => theme.border.color};
  border-radius: 3px;
